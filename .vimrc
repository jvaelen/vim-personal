...
" automatically executed for alle files except tex (you can add more to the
" list) (:help file-pattern)
au BufEnter * exe "set cc=" . (index(['tex'], &ft) != -1 ? '' : '81')
" Alternative: automatically executed when the specified file types are opened
" au FileType cpp,java,c,python set colorcolumn=81
" change snipMate trigger key from <tab> to <C-J>
au VimEnter * imap <C-J> <Plug>snipMateNextOrTrigger
au VimEnter * smap <C-J> <Plug>snipMateNextOrTrigger
...
" Open CtrlP like we opened CmdT
let g:ctrlp_map = '<Leader>t'
" Open the current directory when we launch, not some kind of ancestor
let g:ctrlp_working_path_mode = 0"
" Shortcut for :CtrlPTag -- search in tags list generated by ctags
